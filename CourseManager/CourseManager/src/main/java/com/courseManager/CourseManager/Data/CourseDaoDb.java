...
import com.courseManager.CourseManager.Data.StudentDaoDB.StudentMapper;
import com.courseManager.CourseManager.Data.TeacherDaoDB.TeacherMapper;
...
public class CourseDaoDb implements CourseDao {
    ...
    public Course getCourseById(int id) {
        try {
            ...
            course.setStudents(getStudentForCourse(id));
            return course;
    ...
    private List<Student> getStudentForCourse(int id) {
    ...
    public List<Course> getAllCourses() {
        ...
        List<Course> course = jdbc.query(SELECT_ALL_COURSES, new CourseMapper());
        associateTeacherAndStudents(course);
        return course;
    }
    ...
    private void associateTeacherAndStudents(List<Course> courses) {
        for (Course course : courses) {
            ...
            course.setStudents(getStudentForCourse(course.getId()));
        }
    }
